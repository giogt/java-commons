...
import org.giogt.commons.core.func.Predicate;
...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static final CharMatcher ANY = new CharMatcher() {
        ...
        public int indexIn(CharSequence sequence, int start) {
            ...
            Preconditions.checkPositionIndex(start, length, "start");
        ...
        public boolean matchesAllOf(CharSequence sequence) {
            Preconditions.notNull(sequence, "sequence");
            return true;
        }
        ...
        public CharMatcher and(CharMatcher other) {
            return Preconditions.notNull(other, "other");
        }
    ...
    public static CharMatcher forPredicate(
        ...
        Preconditions.notNull(predicate, "predicate");
        ...
        return new CharMatcher() {
            ...
            public boolean apply(Character character) {
                return predicate.apply(Preconditions.notNull(character, "character"));
            }
        };
    }
     ...
     */
    public CharMatcher and(CharMatcher other) {
        return new And(Arrays.asList(this, Preconditions.notNull(other, "other")));
    }
    ...
    private static class And extends CharMatcher {
        ...
        @Override
        public CharMatcher and(CharMatcher other) {
            List<CharMatcher> newComponents = new ArrayList<>(components);
            newComponents.add(Preconditions.notNull(other, "other"));
     ...
     */
    public CharMatcher or(CharMatcher other) {
        return new Or(Arrays.asList(this, Preconditions.notNull(other, "other")));
    }
