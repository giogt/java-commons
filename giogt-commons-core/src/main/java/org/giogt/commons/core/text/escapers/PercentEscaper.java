package org.giogt.commons.core.text.escapers;
...
public class PercentEscaper extends UnicodeEscaper {
    ...
    /**
     * The GEN delimiters characters, as specified in RFC 3986.
     */
    private static final String GEN_DELIMS = ":/?#[]@";

    /**
     * The SUB delimiters characters, as specified in RFC 3986.
     */
    private static final String SUB_DELIMS = "!$&'()*+,;=";

    /**
     * The unreserved characters, as specified in RFC 3986.
     */
     ...
     * user info, as specified in RFC 3986.
     */
    public static final String SAFE_CHARS_USER_INFO = UNRESERVED + SUB_DELIMS + ":";

    /**
     * A string of characters that do not need to be encoded when used as URI
     * host, as specified in RFC 3986.
     */
    public static final String SAFE_CHARS_HOST = UNRESERVED + SUB_DELIMS;

    /**
     * A string of characters that do not need to be encoded when used in URI
     * path segments, as specified in RFC 3986.
     */
    public static final String SAFE_CHARS_PATH_SEGMENT = UNRESERVED + SUB_DELIMS + ":" + "@";

    /**
     * A string of characters that do not need to be encoded when used in URI
     * path, as specified in RFC 3986.
     */
    public static final String SAFE_CHARS_PATH = SAFE_CHARS_PATH_SEGMENT + "/";

    /**
     * A string of characters that do not need to be encoded when used in URI
     * query strings, as specified in RFC 3986.
     */
    public static final String SAFE_CHARS_QUERY_STRING = SAFE_CHARS_PATH_SEGMENT + "/" + "?";

    /**
     * A string of characters that do not need to be encoded when used in URI
     * query string parameter keys or values, as specified in RFC 3986.
     * <p>
     * Allowed characters in query string parameter keys and values are the
     * same as the whole query string, except <tt>'='</tt> (key value
     * separator) and <tt>'&'</tt> (query parameters separator), that needs to
     * be escaped.
     */
    public static final String SAFE_CHARS_QUERY_STRING_PARAMETER = Strings.removeChars(SAFE_CHARS_PATH_SEGMENT, "=&");

    /**
     * A string of characters that do not need to be encoded when used in URI
     * fragment, as specified in RFC 3986.
     */
    public static final String SAFE_CHARS_FRAGMENT = SAFE_CHARS_PATH_SEGMENT + "/" + "?";
