...
public final class CharEscapers {
    ...
    public static Escaper uriUserInfoEscaper() {
        return URI_USER_INFO_ESCAPER;
    }

    public static Escaper uriHostEscaper() {
        return URI_HOST_ESCAPER;
    }

    public static Escaper uriPathSegmentEscaper() {
    ...
    public static Escaper uriQueryStringParameterEscaper() {
        return URI_QUERY_STRING_PARAMETER_ESCAPER;
    }

    public static Escaper getUriFragmentEscaper() {
    ...
    private static final Escaper URI_USER_INFO_ESCAPER =
            new PercentEscaper(PercentEscaper.SAFE_CHARS_USER_INFO, false);

    private static final Escaper URI_HOST_ESCAPER =
            new PercentEscaper(PercentEscaper.SAFE_CHARS_HOST, false);

    private static final Escaper URI_PATH_SEGMENT_ESCAPER =
            new PercentEscaper(PercentEscaper.SAFE_CHARS_PATH_SEGMENT, false);

    private static final Escaper URI_PATH_ESCAPER =
            new PercentEscaper(PercentEscaper.SAFE_CHARS_PATH, false);

    private static final Escaper URI_QUERY_STRING_ESCAPER =
            new PercentEscaper(PercentEscaper.SAFE_CHARS_QUERY_STRING, false);

    private static final Escaper URI_QUERY_STRING_PARAMETER_ESCAPER =
            new PercentEscaper(PercentEscaper.SAFE_CHARS_QUERY_STRING_PARAMETER, false);

    private static final Escaper URI_FRAGMENT_ESCAPER =
            new PercentEscaper(PercentEscaper.SAFE_CHARS_FRAGMENT, false);
    ...
    public static CharEscaper fallThrough(CharEscaper primary,
        ...
        Preconditions.notNull(primary, "primary");
        Preconditions.notNull(secondary, "secondary");
